...
namespace AdvancedDevSample.Domain.Entities
{
    ...
    public class Customer
    {
        ...
        public Customer(Guid id, string name, string email, string? phone = null, string? address = null, bool isActive = true)
        {
            Id = id == Guid.Empty ? Guid.NewGuid() : id;
            
            if (string.IsNullOrWhiteSpace(name))
            {
                throw new DomainException("Le nom du client ne peut pas être vide.");
            }
            
            if (string.IsNullOrWhiteSpace(email))
            {
                throw new DomainException("L'email du client ne peut pas être vide.");
            }
        ...
        public Customer(string name, string email, string? phone = null, string? address = null) 
